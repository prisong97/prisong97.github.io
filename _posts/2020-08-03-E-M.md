...
As it is easier to deal with a sum of terms instead of a product, we usually introduce the log function and consider the log-likehood function. The log-likelihood function is then:
